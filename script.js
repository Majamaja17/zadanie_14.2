var movies = [
  { 
    ...
    image: src="http://1.fwcdn.pl/po/10/90/1090/7196616.3.jpg"
  },
  
  {
    ...
    image: src="http://1.fwcdn.pl/ph/10/27/1027/426887.1.jpg"
  },

  {
    ...
    image: src="http://1.fwcdn.pl/po/85/86/98586/6906598.3.jpg"
  },

  {
    ...
    image: src="https://is4-ssl.mzstatic.com/image/thumb/Video30/v4/fd/1f/f1/fd1ff191-8578-2fe9-a40c-ac90bd055d53/source/1200x630bb.jpg"
  },
];
...
var moviesElements = movies.map(function(movie) {
  return React.createElement("li", {key: movie.id},
      ...
      React.createElement("img",{src: movie.image, alt: movie.poster},)
    );
});
